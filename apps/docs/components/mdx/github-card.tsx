...
export async function GithubCard({ repo }: { repo: string }) {
  ...
  return (
    <a
      ...
      className="not-prose my-6 flex items-center justify-between rounded-xl border border-border bg-card p-5 transition-colors hover:bg-muted/50"
    >
      ...
      >
        <title id="github-octocat-title">GitHub</title>
        <path
          fillRule="evenodd"
          clipRule="evenodd"
