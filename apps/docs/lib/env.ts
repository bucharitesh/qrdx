...
export const env = createEnv({
  ...
  runtimeEnv: {
    ...
    NEXT_PUBLIC_QRDX_PRO_MONTHLY_PRODUCT_ID: process.env.NEXT_PUBLIC_QRDX_PRO_MONTHLY_PRODUCT_ID,
    NEXT_PUBLIC_QRDX_PRO_YEARLY_PRODUCT_ID: process.env.NEXT_PUBLIC_QRDX_PRO_YEARLY_PRODUCT_ID,
  },
});
